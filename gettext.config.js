...
module.exports = {
  input: {
    path: "./bcgov_arches_common/src", // only files in this directory are considered for extraction
  ...
  output: {
    path: "./bcgov_arches_common/locale", // output path of all created files
