        ...
        resolve({
            ...
            resolve: {
                ...
                alias: {
                    ...
                    'arches/arches/app': Path.resolve(
                        __dirname,
                        ROOT_DIR,
                        'app',
                    ), // ensure project-level imports of arches components point to local file
                    ...Object.fromEntries(
                        ARCHES_APPLICATIONS.map((app) => [
                            // ensure project-level imports of arches application components point to local file
                            Path.join(app, app),
                            Path.resolve(
                                __dirname,
                                ARCHES_APPLICATIONS_PATHS[app],
                            ),
                        ]),
                    ),
                },
