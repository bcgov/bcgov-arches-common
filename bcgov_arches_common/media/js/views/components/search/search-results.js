    ...
    viewModel: BaseFilter.extend({
        ...
        showResourceSummaryReport: function (result) {
            ...
            return function () {
                ...
                if (
                    !self.bulkDisambiguatedResourceInstanceCache()[resourceId]
                ) {
                    const url =
                        arches.urls.api_bulk_disambiguated_resource_instance +
        ...
        updateResults: function () {
            ...
            if (!!this.searchResults.results) {
                ...
                this.searchResults.results.hits.hits.forEach(async function (
                    result,
                ) {
                    var graphdata = _.find(
                        ...
                        function (graphdata) {
                            return (
                                result._source.graph_id === graphdata.graphid
                            );
                        },
                    );
                    var point = null;
                    ...
                    this.results.push({
                        ...
                        relationshipcandidacy: this.toggleRelationshipCandidacy(
                            result._source.resourceinstanceid,
                        ),
