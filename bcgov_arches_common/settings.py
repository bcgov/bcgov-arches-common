...
SECRET_KEY = "django-insecure-+q^ivasr3l0!u@a=)ibw=_#*4!-7p37lx*n+svxpqo*4#awxmw"
...
### To use the OAuth client copy this into your project and provide the appropriate environment variables
